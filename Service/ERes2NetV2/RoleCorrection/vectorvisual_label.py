...
def get_embs(vad_subtitles: list, pure_vocal_audio: np.ndarray, samplerate: int, srt_name: str):
    ...
    print(labels)
    return embs, labels, vad_separate_audios, vad_separate_names


embs1, labels1, vad_separate_audios1, vad_separate_names1 = get_embs(origin_subtitles1, pure_vocal_audio1, samplerate1,
                                                                     "vad_1_2")
