...
from Service.uvr5.utils import spec_utils
from Service.uvr5.utils.stft import STFT
from Service.uvr5.utils.common_separator import CommonSeparator
...
class MDXSeparator(CommonSeparator):
    ...
    def separate(self, audio_file_path):
        ...
        self.logger.info(f"Preparing mix for input audio file {self.audio_file_path}...")
