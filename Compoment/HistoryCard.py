...
from PyQt5.QtWidgets import QWidget, QFileDialog, QFrame, QVBoxLayout, QHBoxLayout, \
...
class VoiceCardItem(QFrame):
    ...
    def __init__(self, title: str, file_path: str = "", voice_id: str= "",parent=None):
        ...
        self.setLayout(layout)
        self.btn.clicked.connect(lambda: self.btn_signal.emit(self.title_text, self.voice_id))
