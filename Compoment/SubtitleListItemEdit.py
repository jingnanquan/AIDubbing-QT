...
class SubtitleListItemEdit(QFrame):
    ...
    def _connect_signals(self):
        """连接信号与槽"""
        self.start_edit.editingFinished.connect(self._schedule_emit)
        self.end_edit.editingFinished.connect(self._schedule_emit)
