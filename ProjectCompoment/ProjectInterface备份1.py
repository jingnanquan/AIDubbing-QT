...
from PyQt5.QtWidgets import QWidget, QFrame, QVBoxLayout, QMessageBox, QApplication, QLabel, QPushButton, QScrollArea, \
    QGridLayout
import os
...
class ProjectCard(QFrame):
    def __init__(self, project, parent=None):
        ...
        elif hasattr(project, "original_video_path") and project.original_video_path and os.path.exists(
